...
import { Clock, Calendar, CheckCircle2, AlertTriangle, Filter, Loader2 } from "lucide-react";
  ...
  const getFilteredLogs = () => {
    ...
    if (searchTerm.trim() !== "") {
      list = list.filter(log => {
        ...
        const empCode = emp ? emp.employee_id.toLowerCase() : "";
        return (
                            ...
                            <td className="py-3 px-4 font-semibold text-ink">
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-[10px] text-muted font-mono">{emp ? emp.employee_id : log.employee_id}</span>
                                </div>
                              </div>
                            </td>
                          )}
